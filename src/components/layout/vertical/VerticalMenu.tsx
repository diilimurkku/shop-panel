  ...
  return (
    ...
    >
      ...
      >
        ...
        <MenuItem
          href={`/${locale}${menuUrls.products}`}
          icon={<i className='ri-shopping-bag-3-line text-[20px]' />}
          title={navigationTranslate.products}
        >
          {navigationTranslate.products}
        </MenuItem>
        <MenuItem
          href={`/${locale}${menuUrls.billing}`}
          icon={<i className='ri-bank-card-line text-[20px]' />}
          title={navigationTranslate.billing_payments}
        >
          {navigationTranslate.billing_payments}
        </MenuItem>
        <MenuItem
          href={`/${locale}${menuUrls.integration}`}
          icon={<i className='ri-links-line text-[20px]' />}
          title={navigationTranslate.integration}
        >
          {navigationTranslate.integration}
        </MenuItem>
        <MenuItem
          href={`/${locale}${menuUrls.settings}`}
          icon={<i className='ri-settings-3-line text-[20px]' />}
          title={navigationTranslate.settings}
        >
